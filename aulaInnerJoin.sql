...
select assinante.nome ,endereco.ds_endereco, telefone.n_fone
from endereco 
inner join assinante
on endereco.cd_assinante = assinante.cd_assinante
inner join telefone 
on 	telefone.cd_endereco = endereco.cd_endereco;



select assinante.nome, endereco.ds_endereco
from assinante
inner join endereco
on endereco.cd_assinante = assinante.cd_assinante;
...
from assinante
inner join endereco
on assinante.cd_assinante = endereco.cd_assinante;
...
select Assinante.nome, Telefone.n_fone
from assinante
inner join endereco
on assinante.cd_assinante  = endereco.cd_assinante
inner join telefone
